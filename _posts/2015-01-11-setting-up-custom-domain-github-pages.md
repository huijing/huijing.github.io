...
4. Edit the records so there are two A records which resolve to the following IP addresses:
    ...
    <img src="/images/posts/cloudflare-2.jpg" alt="Setup DNS records"/>
5. Cloudflare will then tell you to change your nameservers and because they scanned your domain records, they also helpfully tell you exactly what to do. <img src="/images/posts/cloudflare-3.jpg" alt="Edit name servers"/>
...
<img src="/images/posts/name-servers.jpg" alt="Domain manager"/>
7. Change the nameservers according to the instructions provided by Cloudflare and click on Submit. You should see a message telling you that name server changes will take anything from an hour to 2 days to take effect. Mine took probably an hour, I'm not sure, I went out for dinner. <img src="/images/posts/name-servers-2.jpg" alt="Domain manager"/>
