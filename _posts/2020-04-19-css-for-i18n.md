...
<img src="{{ site.url }}/assets/images/posts/bilingual/chrome.png" srcset="{{ site.url }}/assets/images/posts/bilingual/chrome@2x.png 2x" alt="Google translate pop-up built into Chrome">
...
- [Internationalization techniques: Authoring HTML & CSS](https://www.w3.org/International/techniques/authoring-html)
...
- [Localization vs. Internationalization](https://www.w3.org/International/questions/qa-i18n.en)
- [Using the Unicode BIDI Algorithm to Handle Complexities in Typesetting Multi-Script Vertical Text](http://fantasai.inkedblade.net/style/discuss/vertical-text/paper)
